...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
                ...
                options: {
                    ...
                    middleware: function(connect) {
                        return [
                            ...
                            connect.static('test'),
                            connect().use('/bower_components', connect.static('./bower_components')),
                            connect().use('/app/scripts', connect.static('./app/scripts')),
                            connect.static(config.app)
                        ];
                    }
                }
        ...
        exec: {
          generate_parser: {
            cmd: 'node node_modules/jison/lib/cli.js -o app/scripts/grammar.js grammar.jison'
          },
          bower_install: {
